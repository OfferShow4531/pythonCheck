...
# NOTE: Метод создания 3d визуализации
...
# NOTE: Метод выгрузки интерфейса
...
# NOTE: Выгрузка и фильтрация данных
...
# NOTE: Исходный график для всех точек
...
# Создание линий между общими точками
    ...
    #     # Создание линий между всеми общими точками внутри пары элементов
    #     for p1, p2 in common_points:
    #         # Получаем индексы точек в массиве points
    #         point1_index = p1 + element1_index * len(y_coordinates)
    #         point2_index = p2 + element2_index * len(y_coordinates)
    #         line_points = np.array([points[point1_index], points[point2_index]])
